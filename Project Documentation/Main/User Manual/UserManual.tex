...
\item To navigate back to your private chat lists, click on the \textit{Chats} button.\\
\includegraphics[width=100px]{images/GrouplistNav.png}
\end{enumerate}
...
\end{enumerate}
\includegraphics[width=100px]{images/GroupChatCreation.png}
\item You will now be presented with the actual group chat where you can proceed to chat with the members.\\
\includegraphics[width=100px]{images/groupchat.png}
\end{enumerate}
...
\includegraphics[width=100px]{images/groupchatEdit.png}
...
\includegraphics[width=100px]{images/groupchatSend.png}
\end{enumerate}
\item To send a picture/image to the group:
\begin{enumerate}
\item Click on the \textit{Pic} button.\\
\includegraphics[width=100px]{images/groupchatSendPic.png}
